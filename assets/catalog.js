   ...
   },
   {
    ...
    "books": [
     ...
     },
     {
      ...
      "title": "Greedy",
      "tag": "Technique",
      "blurb": "Cách chứng minh một lựa chọn greedy là đúng, ba dạng đề kinh điển, và vì sao greedy sai lại khó phát hiện.",
      "n": 6,
    ...
    "books": [
     {
      ...
      "tag": "Overview",
      "blurb": "Năm khái niệm dùng lại ở mọi model: gọi tên bài toán, phân rã sai số, chia dữ liệu, chống overfitting, chuẩn bị đặc trưng.",
      "n": 3,
